...
![Status: Complete](https://img.shields.io/badge/status-Complete-greensvg)
...
**NOTE:** The expected dictionary is the one found in
/usr/share/dict/words on GNU installations, known as the "GNU common
words dictionary."  Your tests may not pass if you use a bigger
dictionary or if that path is non-existent..  Sorry about that.
